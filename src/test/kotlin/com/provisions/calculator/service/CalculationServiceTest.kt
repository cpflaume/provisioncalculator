...
class CalculationServiceTest {
    ...
    private val depthBasedRule = object : CommissionRule {
        override val ruleId: String = "DEPTH_BASED"
        override val order: Int = 100
        override fun calculate(context: CalculationContext): List<CommissionLineItem> = emptyList()
    }
    ...
    fun `calculate runs engine when no cached result`() {
        ...
        every { calculationRepository.flush() } just Runs
